...
pub trait Driver {
    ...
    /// - transmit timestamp polling can report a timestamp or reclaim a buffer,
    ...
    ///
    /// Drivers may reclaim completed transmit buffers here. Callers must drain
    /// reports even when no timestamps were requested.
    ///
